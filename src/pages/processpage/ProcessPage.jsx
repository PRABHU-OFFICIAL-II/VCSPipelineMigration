  ...
  const handleFramePullRequest = () => {
    ...
    for (const parentId in filteredDependencies) {
      ...
      depInfo.references.forEach((ref) => {
        objectsToInclude.push({
          path: ref.path.split("/"),
          type: ref.documentType.toUpperCase(),
        });
      });
    }
      ...
      <div className="grid-container">
        ...
        <div className="grid-item">
          ...
          <button
            ...
            className={`action-button render-dependencies-button ${
              Object.values(dependenciesLoading).some(Boolean) ? "disabled-button" : ""
            }`}
        ...
        {onGoBack && (
          <>
            ...
            {Object.keys(filteredDependencies).length > 0 && (
              <button onClick={() => {}} className="proceed-to-pull-button">
